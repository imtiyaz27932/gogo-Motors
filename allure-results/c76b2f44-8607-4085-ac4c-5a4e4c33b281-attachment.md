...
Locator: locator('div').filter({ hasText: 'Perfect Fit, Every Time' }).first().locator('p').filter({ hasText: 'Perfect Fit, Every Time' }).first()
Expected: visible
Received: hidden
Call log:
  - expect.toBeVisible with timeout 45000ms
  - waiting for locator('div').filter({ hasText: 'Perfect Fit, Every Time' }).first().locator('p').filter({ hasText: 'Perfect Fit, Every Time' }).first()
    36 × locator resolved to <p class="text-[#000000DE] text-[15px] font-semibold ltr:text-left rtl:text-right">Perfect Fit, Every Time</p>
       - unexpected value "hidden"

    at CarTinting.verifyPerfectFitSection (D:\gogomotor\pages\CarTinting\tinting.ts:529:51)
...
- main:
  ...
  - img "shade-2"
  - img "shade-3"
  - paragraph: 73 glare reduction
  - paragraph: We use advanced ceramic films with precision-fit application and lasting performance
  - paragraph: 26% Solar energy transmittance
  - paragraph: 51% Visible light transmittance
  - paragraph: 0.54 Shading coefficient
  - paragraph: 66% Solar energy absorbance
  - paragraph: 26% Solar energy transmittance
  - paragraph: 7% Visible light reflectance
  - paragraph: 51% Total solar energy rejection
  - paragraph: Autotek IR 50
  - img "Shade 1"
  - img "Shade 2"
  - img "Shade 3"
  - img "Shade 4"
