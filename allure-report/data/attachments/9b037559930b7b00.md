...
- Name: Car Tinting - Mobile Web >> Validate Tint Film Specs section
- Location: D:\gogomotor\tests\CarTinting\windowTinting.spec.ts:44:9
...
Locator: getByText(/glare reduction/i)
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 45000ms
  - waiting for getByText(/glare reduction/i)

    at CarTinting.verifyTintFilmSpecsSection (D:\gogomotor\pages\CarTinting\tinting.ts:495:48)
    at D:\gogomotor\tests\CarTinting\windowTinting.spec.ts:45:23
```
